	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			case 'philly': 
					...
					streetBehind.setGraphicSize(Std.int(streetBehind.width * 1.3));
					add(streetBehind);

					phillyTrain = new FlxSprite(4000, 360).loadGraphic(Paths.image('philly/train','week3'));
					phillyTrain.setGraphicSize(Std.int(phillyTrain.width * 1.3));
					if(FlxG.save.data.distractions){
						add(phillyTrain);
					}
